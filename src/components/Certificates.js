        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="brown-gradient w-10 h-10
  ...
  return (
    <div className="m-auto">
      ...
      <div className="w-full flex flex-wrap justify-center">
        ...
        >
          Following are the certificates I have gained, All these certificates
          reflect my ability to learn and adapt new technologies.
        </motion.p>
      </div>
