  ...
  return (
    <div className="m-auto" id="projects">
      ...
      <div className="w-full flex flex-wrap justify-center">
        ...
        >
          Following projects demonstrates my skills and experience through
          solving real-world problems. Each project is described briefly with
          links to code repositories. All these projects reflect my ability to
          solve complex problems, learn and adapt new technologies.
        </motion.p>
      </div>
